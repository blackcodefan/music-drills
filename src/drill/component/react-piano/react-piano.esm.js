    ...
    value: function render() {
      ...
      return React.createElement("div", {
        className: classNames('ReactPiano__Key', {
          ...
          [`ReactPiano__Key--${className}`]: true
        }),
        style: {
  ...
  _createClass(Keyboard, [{
    ...
    value: function render() {
      ...
      return React.createElement("div", {
        ...
        let notes = _this.props.notes.filter(element => element.piano === midiNumber);
        ...
        if(notes.length > 0){
          ...
          else if(green > 0) className = "Success";
          else if(red > 0) className = 'Danger';
...
export { ControlledPiano, Piano, Keyboard, MidiNumbers };
